				...
				<div class='new_ts'>
					<div class='first'>
						<select required name="annotations" class='keyword'><option
							...
							placeholder='Enter Description of Test Step' required>
					</div>
					<div class='second'>
						<select name="operations" class='operation' id='operation_1'
							...
							<option value='hover'>Hover</option></select><input type='textbox'
							name="locator" class='test_case_name' id='tb1_1'
							placeholder='Enter the Locator'><input type='textbox'
							name="userText" class='test_case_send_keys_text' id='st1_1'
							placeholder='Enter the input text'><input type='textbox'
							name="locatorDestination" class='test_case_send_keys_text'
							id='st2_1' placeholder='Locator of destination element'>
					</div>
				</div>
				<div>
